...
import { IconTrendingUp, IconTrendingDown, IconArrowDown } from '@tabler/icons-react'

interface OrderBookProps {
  orderBook: OrderBook
}

export default function OrderBookDisplay({ orderBook }: OrderBookProps) {
    ...
    <Card className="border-border/50 shadow-lg">
      ...
      <CardContent className="p-6">
        ...
        <div className="max-h-[600px] overflow-y-auto">
          ...
          <div className="sticky top-0 z-10 my-3 p-4 bg-secondary/30 backdrop-blur-sm rounded-lg border border-border/50">
            ...
            <div className="text-xs text-muted-foreground">Mid Market Price</div>
          </div>
